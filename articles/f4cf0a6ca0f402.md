...
### 1-1. GradleとAGP(Android Gradle Plugin)の関係
...
### 1-6. app/build.gradle.kts（モジュールレベル）
...
### 1-9. libs.versions.toml（バージョンカタログ）
